...
`,Ek=Xe.p`
  ...
  font-size: 8px;
  text-align: right;
`;function Tk(n){const{id:e,year:t,country:r,place:a,date:o,passenger:u,thumbnail:d,barColor:p,post:m="#e0e0e0"}=n,{title:_,content:v}=m||{},w=lm(),S=M=>M?M.length<=3?[M,""]:[M.slice(0,2),M.slice(2)]:["",""],[x,U]=S(a);return Y.jsx("div",{onClick:()=>w(`/post/${e}`),className:"ticket-wrapper",children:Y.jsxs(hk,{color:p,children:[Y.jsx(dk,{color:p}),Y.jsx(fk,{color:p}),Y.jsxs("div",{style:{padding:"0px 12px"},className:"visible",children:[Y.jsx(mk,{children:t||"2025"}),Y.jsx("img",{src:"./public/Plane.svg",alt:"Plane icon",style:{display:"block",marginLeft:"auto",marginBottom:"8px",marginRight:"8px",width:"24px"}}),Y.jsx(gk,{children:r}),Y.jsxs(yk,{children:[x,Y.jsx("br",{}),U]}),Y.jsxs(_k,{children:[Y.jsxs(vk,{children:["DATE",Y.jsx("br",{}),o]}),Y.jsxs(Ek,{children:["PASSENGER",Y.jsx("br",{}),u||"@di_ed_ie"]})]}),Y.jsx(pk,{src:"./public/qrcode.svg",alt:"QR Code"})]}),Y.jsxs("div",{className:"HoverContent",children:[Y.jsx("img",{src:d||"/thumbnail.png",style:{width:"206px",height:"139px",objectFit:"cover"}}),Y.jsxs("div",{className:"HoverContent_container",children:[Y.jsx("h2",{style:{fontFamily:"Pretendard-Regular",fontSize:"12px",color:"white",fontWeight:"700"},children:_}),Y.jsx("h2",{style:{fontFamily:"Pretendard-Regular",fontSize:"12px",color:"white",fontWeight:"100",lineHeight:"146%"},children:v})]}),Y.jsx("p",{style:{marginTop:"8px",marginLeft:"150px",marginRight:"14px",fontSize:"8px",color:"white",fontWeight:"100"},children:u||"@di_ed_ie"})]})]})})}const wk=Xe.div`
  box-sizing: border-box;
  position: relative;
  background-color: white;
  width: 396px;
