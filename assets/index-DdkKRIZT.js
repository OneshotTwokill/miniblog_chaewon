...
`;function Uv(n){const{title:e,onClick:t,width:r}=n;return Q.jsx(lk,{width:r||"",onClick:t,children:e||"Button"})}const uk=Xe.div`
  width: 46px;
  height: 46px;
...
`;function ck({color:n,isActive:e,onClick:t}){return Q.jsx(uk,{color:n,className:e?"active":"",onClick:t})}const hk=Xe.div`
  cursor: pointer;
...
`,Ek=Xe.p`
  ...
  font-size: 8px;
  text-align: right;
`;function Tk(n){const{id:e,year:t,country:r,place:a,date:o,passenger:u,thumbnail:d,barColor:p,post:m="#e0e0e0"}=n,{title:_,content:v}=m||{},w=lm(),S=M=>M?M.length<=3?[M,""]:[M.slice(0,2),M.slice(2)]:["",""],[x,U]=S(a);return Q.jsx("div",{onClick:()=>w(`/post/${e}`),className:"ticket-wrapper",children:Q.jsxs(hk,{color:p,children:[Q.jsx(dk,{color:p}),Q.jsx(fk,{color:p}),Q.jsxs("div",{style:{padding:"0px 12px",position:"relative"},className:"visible",children:[Q.jsx(mk,{children:t||"2025"}),Q.jsx("img",{src:"/Plane.svg",alt:"Plane icon",style:{display:"block",marginLeft:"auto",marginBottom:"8px",marginRight:"8px",width:"24px"}}),Q.jsx(gk,{children:r}),Q.jsxs(yk,{children:[x,Q.jsx("br",{}),U]}),Q.jsxs(_k,{children:[Q.jsxs(vk,{children:["DATE",Q.jsx("br",{}),o]}),Q.jsxs(Ek,{children:["PASSENGER",Q.jsx("br",{}),u||"@di_ed_ie"]})]}),Q.jsx(pk,{src:"/qrcode.svg",alt:"QR Code"})]}),Q.jsxs("div",{className:"HoverContent",children:[Q.jsx("img",{src:d||"/thumbnail.png",style:{width:"206px",height:"139px",objectFit:"cover"}}),Q.jsxs("div",{className:"HoverContent_container",children:[Q.jsx("h2",{style:{fontFamily:"Pretendard-Regular",fontSize:"12px",color:"white",fontWeight:"700"},children:_}),Q.jsx("h2",{style:{fontFamily:"Pretendard-Regular",fontSize:"12px",color:"white",fontWeight:"100",lineHeight:"146%"},children:v})]}),Q.jsx("p",{style:{marginTop:"8px",marginLeft:"150px",marginRight:"14px",fontSize:"8px",color:"white",fontWeight:"100"},children:u||"@di_ed_ie"})]})]})})}const wk=Xe.div`
  box-sizing: border-box;
  position: relative;
  background-color: white;
  width: 396px;
...
`,Ak=Xe.img`
  ...
  max-width: 91px;
  height: auto;
`;function Sk(n){const{year:e,country:t,place:r,date:a,thumbnail:o,passenger:u,barColor:d,post:p,onClick:m="#e0e0e0"}=n,{title:_,content:v}=p||{};return Q.jsxs("div",{onClick:m,className:"ticket-wrapper2",style:{paddingBottom:"23px",paddingTop:"23px",borderBottom:" 1px solid #BEBEBE"},children:[Q.jsxs(wk,{children:[Q.jsx(Ik,{color:d}),Q.jsxs("div",{style:{padding:"0px 12px",height:"100%",display:"flex",flexDirection:"column",gap:"0px"},children:[Q.jsxs("div",{style:{display:"flex",alignItems:"center"},children:[Q.jsx("img",{src:"/Plane.svg",alt:"Plane icon",style:{display:"block",marginLeft:"auto",marginBottom:"0px",marginRight:"28px",width:"24px"}}),Q.jsx("h1",{style:{width:"74px",fontSize:"30px",color:"#9F9F9F",fontWeight:"300",margin:"0px",paddingBottom:"8px",paddingLeft:"0px",marginTop:"14px"},children:e||"2025"})]}),Q.jsx("p",{style:{position:"absolute",top:"24px",margin:"0 0 4px 0",color:"white",backgroundColor:"black",width:"68px",height:"27px",textAlign:"center",fontSize:"19px",fontWeight:"100",display:"flex",alignItems:"center",justifyContent:"center"},children:t}),Q.jsx("h2",{style:{position:"absolute",top:"55px",margin:"0",fontSize:"52px",fontWeight:"700",paddingLeft:"16px",paddingBottom:"20px",marginBottom:"0px",wordBreak:"break-word"},children:r}),Q.jsxs("div",{style:{position:"absolute",top:"126px",width:"150px",display:"flex",justifyContent:"space-between",padding:"0px 8px",paddingLeft:"20px",lineHeight:"90%"},children:[Q.jsxs("p",{style:{marginLeft:"4px",fontSize:"7px",color:"#1A1A1A"},children:["DATE",Q.jsx("br",{}),a]}),Q.jsxs("p",{style:{marginRight:"4px",fontSize:"7px",textAlign:"right",color:"#1A1A1A"},children:["PASSENGER",Q.jsx("br",{}),u||"@di_ed_ie"]})]})]}),Q.jsx(Ak,{src:"./qrcode.svg",alt:"QR Code"})]}),Q.jsxs("div",{style:{width:"802px",height:"168px",paddingLeft:"24px",display:"flex",flexDirection:"column",justifyContent:"space-between"},children:[Q.jsxs("div",{style:{display:"block",overflow:"hidden"},children:[Q.jsx("h2",{className:"List_TicketTitle",children:_}),Q.jsx("h2",{className:"List_TicketContent",children:v})]}),Q.jsxs("div",{style:{paddingTop:"10px",display:"flex",justifyContent:"space-between"},children:[Q.jsx("p",{style:{color:"#3A3A3A"},children:a}),Q.jsx("p",{style:{color:"#7B7B7B"},children:u||"@di_ed_ie"})]})]})]})}const Rk=Xe.div`
display: flex;
flex-wrap: wrap;
margin: 0 auto;
justify-content: space-between;
...
overflow-y: auto;            
`,Dk={height:"calc(100vh - 124px)",overflowY:"auto"};function xk({posts:n,layout:e,itemClicked:t}){const r=e==="grid"?Tk:Sk,a=e==="grid"?Rk:Ck;return Q.jsx("div",{style:Dk,children:Q.jsx(a,{children:n.map(o=>Q.jsx(r,{post:o,id:o.id,year:o.year,country:o.country,place:o.place,date:o.date,passenger:o.passenger,thumbnail:o.image,barColor:o.color,onClick:()=>t(o)},o.id))})})}const Pk=()=>{};var tI={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function va(n){if(n.code!==W.FAILED_PRECONDITION||n.message!==CC)throw n;re("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bn="WebChannelConnection";class Oz extends Pz{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}vo(e,t,r,a){const o=_v();return new Promise((u,d)=>{const p=new _C;p.setWithCredentials(!0),p.listenOnce(vC.COMPLETE,()=>{try{switch(p.getLastErrorCode()){case gp.NO_ERROR:const _=p.getResponseJson();re(bn,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(_)),u(_);break;case gp.TIMEOUT:re(bn,`RPC '${e}' ${o} timed out`),d(new te(W.DEADLINE_EXCEEDED,"Request time out"));break;case gp.HTTP_ERROR:const v=p.getStatus();if(re(bn,`RPC '${e}' ${o} failed with status:`,v,"response text:",p.getResponseText()),v>0){let w=p.getResponseJson();Array.isArray(w)&&(w=w[0]);const S=w==null?void 0:w.error;if(S&&S.status&&S.message){const x=function(M){const H=M.toLowerCase().replace(/_/g,"-");return Object.values(W).indexOf(H)>=0?H:W.UNKNOWN}(S.status);d(new te(x,S.message))}else d(new te(W.UNKNOWN,"Server responded with status "+p.getStatus()))}else d(new te(W.UNAVAILABLE,"Connection failed."));break;default:me()}}finally{re(bn,`RPC '${e}' ${o} completed.`)}});const m=JSON.stringify(a);re(bn,`RPC '${e}' ${o} sending request:`,a),p.send(t,"POST",m,r,15)})}Wo(e,t,r){const a=_v(),o=[this.po,"/","google.firestore.v1.Firestore","/",e,"/channel"],u=wC(),d=TC(),p={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},m=this.longPollingOptions.timeoutSeconds;m!==void 0&&(p.longPollingTimeout=Math.round(1e3*m)),this.useFetchStreams&&(p.useFetchStreams=!0),this.Do(p.initMessageHeaders,t,r),p.encodeInitMessageHeaders=!0;const _=o.join("");re(bn,`Creating RPC '${e}' stream ${a}: ${_}`,p);const v=u.createWebChannel(_,p);let w=!1,S=!1;const x=new Nz({Fo:M=>{S?re(bn,`Not sending because RPC '${e}' stream ${a} is closed:`,M):(w||(re(bn,`Opening RPC '${e}' stream ${a} transport.`),v.open(),w=!0),re(bn,`RPC '${e}' stream ${a} sending:`,M),v.send(M))},Mo:()=>v.close()}),U=(M,H,$)=>{M.listen(H,K=>{try{$(K)}catch(oe){setTimeout(()=>{throw oe},0)}})};return U(v,ch.EventType.OPEN,()=>{S||(re(bn,`RPC '${e}' stream ${a} transport opened.`),x.Qo())}),U(v,ch.EventType.CLOSE,()=>{S||(S=!0,re(bn,`RPC '${e}' stream ${a} transport closed`),x.Uo())}),U(v,ch.EventType.ERROR,M=>{S||(S=!0,di(bn,`RPC '${e}' stream ${a} transport errored:`,M),x.Uo(new te(W.UNAVAILABLE,"The operation could not be completed")))}),U(v,ch.EventType.MESSAGE,M=>{var H;if(!S){const $=M.data[0];_e(!!$);const K=$,oe=(K==null?void 0:K.error)||((H=K[0])===null||H===void 0?void 0:H.error);if(oe){re(bn,`RPC '${e}' stream ${a} received error:`,oe);const ae=oe.status;let le=function(A){const P=jt[A];if(P!==void 0)return E1(P)}(ae),D=oe.message;le===void 0&&(le=W.INTERNAL,D="Unknown error status: "+ae+" with message "+oe.message),S=!0,x.Uo(new te(le,D)),v.close()}else re(bn,`RPC '${e}' stream ${a} received:`,$),x.Ko($)}}),U(d,EC.STAT_EVENT,M=>{M.stat===Y_.PROXY?re(bn,`RPC '${e}' stream ${a} detected buffering proxy`):M.stat===Y_.NOPROXY&&re(bn,`RPC '${e}' stream ${a} detected no buffering proxy`)}),setTimeout(()=>{x.$o()},0),x}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mz{}class Lz extends Mz{constructor(e,t,r,a){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=r,this.serializer=a,this.F_=!1}M_(){if(this.F_)throw new te(W.FAILED_PRECONDITION,"The client has already been terminated.")}So(e,t,r,a){return this.M_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([o,u])=>this.connection.So(e,hv(t,r),a,o,u)).catch(o=>{throw o.name==="FirebaseError"?(o.code===W.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),o):new te(W.UNKNOWN,o.toString())})}Co(e,t,r,a,o){return this.M_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([u,d])=>this.connection.Co(e,hv(t,r),a,u,d,o)).catch(u=>{throw u.name==="FirebaseError"?(u.code===W.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),u):new te(W.UNKNOWN,u.toString())})}terminate(){this.F_=!0,this.connection.terminate()}}class Uz{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.x_=0,this.O_=null,this.N_=!0}B_(){this.x_===0&&(this.L_("Unknown"),this.O_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.O_=null,this.k_("Backend didn't respond within 10 seconds."),this.L_("Offline"),Promise.resolve())))}q_(e){this.state==="Online"?this.L_("Unknown"):(this.x_++,this.x_>=1&&(this.Q_(),this.k_(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.L_("Offline")))}set(e){this.Q_(),this.x_=0,e==="Online"&&(this.N_=!1),this.L_(e)}L_(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}k_(e){const t=`Could not reach Cloud Firestore backend. ${e}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pi{constructor(e){this._byteString=e}static fromBase64String(e){try{return new pi(Dt.fromBase64String(e))}catch(t){throw new te(W.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new pi(Dt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ma=class{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new te(W.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new pt(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gm{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new te(W.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new te(W.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return Se(this._lat,e._lat)||Se(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jm(n,e,t){let r;return r=n?t&&(t.merge||t.mergeFields)?n.toFirestore(e,t):n.toFirestore(e):e,r}class c5 extends vT{constructor(e){super(),this.firestore=e}convertBytes(e){return new pi(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Tt(this.firestore,null,t)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let I5=class extends b5{constructor(e,t){super(e,t),this._firestore=e}get(e){const t=Zs(e,this._firestore),r=new zo(this._firestore);return super.get(e).then(a=>new Ji(this._firestore,r,t._key,a._document,new mo(!1,!1),t.converter))}};function A5(n,e,t){n=Ye(n,Lt);const r=Object.assign(Object.assign({},T5),t);return function(o){if(o.maxAttempts<1)throw new te(W.INVALID_ARGUMENT,"Max attempts must be at least 1")}(r),function(o,u,d){const p=new _n;return o.asyncQueue.enqueueAndForget(async()=>{const m=await P9(o);new D9(o.asyncQueue,m,d,u,p).Iu()}),p.promise}(Sn(n),a=>e(new I5(n,a)),r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function S5(){return new wd("deleteField")}function R5(){return new lT("serverTimestamp")}function C5(...n){return new uT("arrayUnion",n)}function D5(...n){return new cT("arrayRemove",n)}function x5(n){return new hT("increment",n)}(function(e,t=!0){(function(a){ku=a})(ya),oa(new ci("firestore",(r,{instanceIdentifier:a,options:o})=>{const u=r.getProvider("app").getImmediate(),d=new Lt(new I4(r.getProvider("auth-internal")),new R4(u,r.getProvider("app-check-internal")),function(m,_){if(!Object.prototype.hasOwnProperty.apply(m.options,["projectId"]))throw new te(W.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ua(m.options.projectId,_)}(u,a),u);return o=Object.assign({useFetchStreams:t},o),d._setSettings(o),d},"PUBLIC").setMultipleInstances(!0)),Or(MI,LI,e),Or(MI,LI,"esm2017")})();const P5="@firebase/firestore-compat",N5="0.3.45";/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Iv(n){return O5(n,["next","error","complete"])}function O5(n,e){if(typeof n!="object"||n===null)return!1;const t=n;for(const r of e)if(r in t&&typeof t[r]=="function")return!0;return!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class co{static serverTimestamp(){const e=R5();return e._methodName="FieldValue.serverTimestamp",new co(e)}static delete(){const e=S5();return e._methodName="FieldValue.delete",new co(e)}static arrayUnion(...e){const t=C5(...e);return t._methodName="FieldValue.arrayUnion",new co(t)}static arrayRemove(...e){const t=D5(...e);return t._methodName="FieldValue.arrayRemove",new co(t)}static increment(e){const t=x5(e);return t._methodName="FieldValue.increment",new co(t)}constructor(e){this._delegate=e}isEqual(e){return this._delegate.isEqual(e._delegate)}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const L5={Firestore:XD,GeoPoint:Gm,Timestamp:gt,Blob:Xh,Transaction:ZD,WriteBatch:JD,DocumentReference:Er,DocumentSnapshot:Zh,Query:Nn,QueryDocumentSnapshot:Jh,QuerySnapshot:Av,CollectionReference:Au,FieldPath:wT,FieldValue:co,setLogLevel:V5,CACHE_SIZE_UNLIMITED:j9};function U5(n,e){n.INTERNAL.registerComponent(new ci("firestore-compat",t=>{const r=t.getProvider("app-compat").getImmediate(),a=t.getProvider("firestore").getImmediate();return e(r,a)},"PUBLIC").setServiceProps(Object.assign({},L5)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function B5(n){U5(n,(e,t)=>new XD(e,t,new k5)),n.registerVersion(P5,N5)}B5(xu);const z5={apiKey:"AIzaSyAJa3iZYHCFjFC1suil_4g9E_FujVCSfhM",authDomain:"mini-blog-chaewon.firebaseapp.com",projectId:"mini-blog-chaewon",storageBucket:"mini-blog-chaewon.firebasestorage.app",messagingSenderId:"592149089393",appId:"1:592149089393:web:54e7e27b4df5d1a6705fd0"},F5=xu.initializeApp(z5),am=F5.firestore();function j5(n){const e=lm(),[t,r]=X.useState([]),[a,o]=X.useState([]),[u,d]=X.useState("list");return X.useEffect(()=>{let p=[];am.collection("post").orderBy("id","desc").get().then(m=>{m.forEach(_=>{p.push({id:_.id,..._.data()})}),r(p),o(p.slice(0,5))})},[]),Q.jsxs("div",{className:"bodyPadding",style:{height:"900px",overflow:"hidden",display:"flex",flexDirection:"column"},children:[Q.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginBottom:"46px",alignItems:"flex-end"},children:[Q.jsxs("div",{children:[Q.jsxs("div",{style:{display:"flex",gap:"7px"},children:[Q.jsxs("div",{style:{display:"flex"},children:[Q.jsx("h2",{className:"Text1",children:"12"}),Q.jsx("h2",{className:"Text2",children:"D"})]}),Q.jsxs("div",{style:{display:"flex"},children:[Q.jsx("h2",{className:"Text1",children:"18"}),Q.jsx("h2",{className:"Text2",children:"H"})]}),Q.jsxs("div",{style:{display:"flex"},children:[Q.jsx("h2",{className:"Text1",children:"23"}),Q.jsx("h2",{className:"Text2",children:"M"})]})]}),Q.jsxs("div",{style:{display:"flex",marginTop:"7px"},children:[Q.jsx("h2",{className:"Text1",children:"146,321"}),Q.jsx("h2",{className:"Text2",children:"km"})]})]}),Q.jsxs("div",{style:{display:"flex",alignItems:"center"},children:[Q.jsx("img",{src:"/gridIcon1.png",style:{cursor:"pointer",opacity:u==="grid"?1:.5},onClick:()=>d("grid")}),Q.jsx("img",{src:"/gridIcon2.png",style:{cursor:"pointer",opacity:u==="list"?1:.5},onClick:()=>d("list")})]}),Q.jsxs("div",{style:{padding:"20px",background:"#eee"},children:[Q.jsx("img",{src:"/gridIcon1.png",style:{width:"50px"}}),Q.jsx("img",{src:"/gridIcon2.png",style:{width:"50px"}})]})]}),Q.jsx(xk,{posts:u==="list"?t:a,layout:u,itemClicked:p=>{console.log("클릭됨:",p.id),e(`/post/${p.id}`)}}),Q.jsx("div",{className:"whiteBox2"}),Q.jsx("div",{style:{position:"absolute",bottom:"100px",left:"50%",transform:"translateX(-50%)"},children:Q.jsx(Uv,{title:"글 작성하기",onClick:p=>{e("/write")}})})]})}const q5=Xe.textarea`
...
`;function lS(n){const{width:e,height:t,value:r,placeholder:a,fontsize:o,borderColor:u,onChange:d}=n;return Q.jsx(q5,{width:e||20,height:t||20,value:r,borderColor:u||"#B7B7B7",placeholder:a||"",fontsize:o||20,onChange:d})}const H5=Xe.textarea`
...
`;function Sp(n){const{width:e,height:t,radius:r,value:a,onChange:o,placeholder:u}=n;return Q.jsx(H5,{width:e||20,height:t||20,radius:r||20,placeholder:u||"",value:a,onChange:o})}function G5({value:n,onChange:e}){const t=["#D35456","#FE9015","#FEE315","#63D354","#1595FE"],r=t.findIndex(o=>o===n),a=o=>{const u=t[o];e(u)};return Q.jsx("div",{style:{display:"flex"},children:t.map((o,u)=>Q.jsx(ck,{color:o,isActive:r===u,onClick:()=>a(u)},u))})}function $5(n){const e=lm(),[t,r]=X.useState(""),[a,o]=X.useState(""),[u,d]=X.useState(""),[p,m]=X.useState(""),[_,v]=X.useState(""),[w,S]=X.useState(""),x=()=>{if(!w){alert("색상을 선택해주세요!");return}let $=new Date().getTime().toString();am.collection("post").doc($).set({id:$,title:t,content:a,country:u,place:p,date:_,comments:[],color:w,image:U}).then(()=>{alert("글이 등록되었습니다!"),e("/")})},[U,M]=X.useState(null),H=$=>{let K=new FileReader;K.readAsDataURL($.target.files[0]),K.onload=oe=>{console.log(oe.target.result),M(oe.target.result)}};return Q.jsxs("div",{children:[Q.jsxs("div",{className:"bodyPadding2",children:[Q.jsxs("div",{style:{display:"flex",gap:"24px"},children:[Q.jsx("h2",{style:{fontSize:"28px",fontWeight:"100",color:"#FE9015"},children:"LADING PASS"}),Q.jsx("h2",{style:{fontSize:"28px",fontWeight:"100",color:"#FE9015",fontFamily:'"Fuzzy Bubbles", sans-serif'},children:"Check-List"})]}),Q.jsxs("div",{style:{display:"flex",gap:"30px",justifyContent:"space-evenly"},children:[Q.jsxs("div",{className:"InputBox",children:[Q.jsx("span",{className:"NumBox",children:"1"}),Q.jsx(Sp,{width:"266",height:"50",radius:"10",placeholder:"나라를 입력해주세요",value:u,onChange:$=>d($.target.value)})]}),Q.jsxs("div",{className:"InputBox",children:[Q.jsx("span",{className:"NumBox",children:"2"}),Q.jsx(Sp,{width:"266",height:"50",radius:"10",placeholder:"지역을 입력해주세요",value:p,onChange:$=>m($.target.value)})]}),Q.jsxs("div",{className:"InputBox",children:[Q.jsx("span",{className:"NumBox",children:"3"}),Q.jsx(Sp,{width:"266",height:"50",radius:"10",placeholder:"날짜를 입력해주세요",value:_,onChange:$=>v($.target.value)})]})]}),Q.jsx("div",{style:{display:"flex",marginLeft:"26px"},children:Q.jsx(G5,{value:w,onChange:$=>S($)})})]}),Q.jsxs("div",{className:"bodyPadding2",children:[Q.jsx("div",{style:{marginBottom:"30px"},children:Q.jsx(lS,{width:"1050",height:"50",value:t,placeholder:"제목",fontsize:"32",onChange:$=>r($.target.value)})}),Q.jsxs("div",{style:{width:"874px",position:"relative"},children:[Q.jsx(lS,{width:"1050",height:"320",value:a,borderColor:"none",placeholder:"내용을 작성해주세요",onChange:$=>o($.target.value)}),U&&Q.jsx("img",{src:U,alt:"미리보기",className:"ContentImage",style:{position:"absolute",bottom:"-50px",right:"-180px",width:"150px",objectFit:"cover",borderRadius:"10px",boxShadow:"0 0 5px rgba(0,0,0,0.2)"}})]}),Q.jsx("input",{type:"file",id:"image-upload",accept:"image/*",onChange:$=>H($),style:{display:"none"}}),Q.jsx("div",{style:{position:"absolute",bottom:"82px",left:"50%",transform:"translateX(-50%)"},children:Q.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"18px"},children:[Q.jsx(Uv,{title:"업로드",onClick:$=>{x()}}),Q.jsx("label",{htmlFor:"image-upload",className:"ImageInput"})]})})]})]})}const K5=Xe.div`
    background-color: none;
    display: block;
    line-height:160%;
...
font-size:18px;
font-weight:100;
`;function X5(n){const{post:e}=n;return Q.jsxs(K5,{children:[Q.jsx(Q5,{children:e.title}),Q.jsx(W5,{children:e.content}),e.image&&Q.jsx("img",{src:e.image,alt:"업로드 이미지",style:{width:"200px",height:"200px",borderRadius:"10px",marginTop:"16px",objectFit:"cover"}}),Q.jsxs(Y5,{children:[Q.jsx("p",{children:"2025.3.3"}),Q.jsx("p",{children:"@di_ed_ie"})]})]})}const Z5=Xe.div`
 display: flex;
  justify-content: space-between;
  align-items: center; 
  height: 47px;
...
`,t6=Xe.div`
  ...
  justify-content: center;
  cursor: pointer;
`;function n6(n){const{comment:e}=n;return Q.jsxs(Z5,{children:[Q.jsxs("div",{style:{display:"flex",alignItems:"center"},children:[Q.jsx(t6,{}),Q.jsx(J5,{children:e.content})]}),Q.jsx(e6,{children:"@di_ed_ie"})]})}const r6=Xe.div`
  height: 380px;       
  overflow-y: auto;       
  padding-right: 8px;         
  display: flex;
  flex-direction: column;
  gap: 13px;
`;function i6({comments:n}){return Q.jsx(r6,{children:n.map(e=>Q.jsx(n6,{comment:e},e.id))})}const s6=Xe.div`
  width: 48px;
  height: 48px;
  background-color: #e0e0e0;
  border-radius: 50%;
  ...
  align-items: center;
  justify-content: center;
`;function a6(n){const e=dN().id,[t,r]=X.useState({id:e,title:"",content:"",comments:[],image:""});X.useEffect(()=>{am.collection("post").doc(e).get().then(m=>{r(m.data())})},[]),X.useEffect(()=>{d(t.comments||[])},[t]);const[a,o]=X.useState(""),[u,d]=X.useState(t.comments||[]),p=async()=>{if(a.trim()==="")return;const _=[{content:a,author:"익명",createdAt:new Date},...u];d(_),o("");try{await am.collection("post").doc(e).update({comments:_})}catch(v){console.error("댓글 저장 중 오류 발생:",v)}};return Q.jsx("div",{className:"bodyPadding",children:Q.jsxs("div",{style:{paddingLeft:"5%",paddingRight:"5%",boxSizing:"border-box",overflow:"hidden"},children:[Q.jsx(X5,{post:t}),Q.jsx("h1",{style:{fontSize:"24px",paddingTop:"20px",paddingBottom:"30px"},children:"COMMENT"}),Q.jsx(i6,{comments:u}),Q.jsx("div",{className:"whiteBox"}),Q.jsxs("div",{style:{display:"flex",gap:"8px",marginTop:"30px",alignItems:"center",position:"absolute",bottom:"50px"},children:[Q.jsx(s6,{}),Q.jsx(Sp,{width:"874",height:"50",radius:"100",value:a,onChange:m=>o(m.target.value),placeholder:"댓글을 작성해주세요."}),Q.jsx(Uv,{title:"작성하기",width:"177",onClick:p})]})]})})}MP.createRoot(document.getElementById("root")).render(Q.jsx("div",{children:Q.jsx(YN,{basename:"/miniblog_chaewon/",children:Q.jsxs(RN,{children:[Q.jsx(ip,{index:!0,element:Q.jsx(j5,{})}),Q.jsx(ip,{path:"write",element:Q.jsx($5,{})}),Q.jsx(ip,{path:"post/:id",element:Q.jsx(a6,{})})]})})}));
